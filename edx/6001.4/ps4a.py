...
def getWordScore(word, n):
    ...
    i=0
    for e in word:
        i+=SCRABBLE_LETTER_VALUES[e]
        
    if len(word)is n:
        return i*len(word)+50
    else:
        return i*len(word)
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) is not 0:
        # Display the hand
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                k=getWordScore(word,n)
                point+=k
                print('" '+str(word)+' " earned '+str(k)+' points. Total: '+str(point)+' points\n')   
                # Update the hand 
                hand=updateHand(hand,word)

    # Game is over (user entered a '.' or ran out of letters), so tell user the total score
    
    if calculateHandlen(hand) is 0:
        print('Run out of letters. Total score: ' +str(point)+ ' points.')
    else:
        print('Goodbye! Total score: '+ str(point) + ' points.')
...
def playGame(wordList):
    ...
    while (user != 'e'):
        ...
        while not (user is 'r' or user is 'n' or user is 'e'):
